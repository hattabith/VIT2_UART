// версія з переписаним кодом, оптимізовані деякі функції
// зменшено кількість змінних, додано коректний вивід
// убраны функции работы с внешней  на часах реального времени прибрано функції роботи з зовнішньою EEPROM на годиннику реального часу
// скетч повністю робочий з коректним виводом в порт, тільки парсити
// Watchdog дана версія не підтримує
...
void loop() {
  ...
  if (MStartMeasurment) {
    adc0 = ads.readADC_Differential_0_1(); // міряємо напругу
